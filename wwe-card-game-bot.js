...
const CONFIG = {
    ...
    MAX_SQUAD_SIZE: 25,
    PLAYING_XI_SIZE: 5,
    STARTING_DISTRIBUTION: { COMMON: 3, RARE: 1, EPIC: 1 },
    DROP_RATES: { COMMON: 50, RARE: 30, EPIC: 15, LEGENDARY: 4, MYTHIC: 1 },
    XP_PER_WIN: 100,
    XP_PER_LOSS: 25,
    BASE_LEVEL_XP: 1000,
    XP_MULTIPLIER: 1.5,
    COLORS: { PRIMARY: '#FF0000', SUCCESS: '#00FF00', ERROR: '#FF0000', WARNING: '#FFA500', INFO: '#0099FF', COMMON: '#808080', RARE: '#0070DD', EPIC: '#A335EE', LEGENDARY: '#FF8000', MYTHIC: '#FFD700' },
    CARD_COLORS: {
        COMMON: { primary: '#708090', secondary: '#4A5568', accent: '#95A5B8', text: '#FFFFFF', glow: 'rgba(112, 128, 144, 0.5)', shine: '#C0C0C0' },
        RARE: { primary: '#0070DD', secondary: '#004d99', accent: '#00A3FF', text: '#FFFFFF', glow: 'rgba(0, 112, 221, 0.6)', shine: '#4DA6FF' },
        EPIC: { primary: '#A335EE', secondary: '#7a1fb8', accent: '#C655FF', text: '#FFFFFF', glow: 'rgba(163, 53, 238, 0.7)', shine: '#E066FF' },
        LEGENDARY: { primary: '#FF8000', secondary: '#cc6600', accent: '#FFB84D', text: '#FFFFFF', glow: 'rgba(255, 128, 0, 0.8)', shine: '#FFD700' },
        MYTHIC: { primary: '#FFD700', secondary: '#FFA500', accent: '#FFED4E', text: '#000000', glow: 'rgba(255, 215, 0, 0.9)', shine: '#FFFACD' }
    }
};
...
const WRESTLERS_DATABASE = {
    'UNDERTAKER': { id: 'UNDERTAKER', name: 'The Undertaker', rarity: 'MYTHIC', basePrice: 3500000, stats: { overall: 98, power: 95, speed: 80, stamina: 90, technique: 96, charisma: 98, defense: 94 }, finisher: 'Tombstone Piledriver', brand: 'Legend', signature: 'The Deadman', imageUrl: 'https://i.imgur.com/QxR8VpK.png' },
    'STONE_COLD': { id: 'STONE_COLD', name: 'Stone Cold Steve Austin', rarity: 'MYTHIC', basePrice: 3450000, stats: { overall: 97, power: 94, speed: 84, stamina: 93, technique: 90, charisma: 99, defense: 91 }, finisher: 'Stone Cold Stunner', brand: 'Legend', signature: 'The Texas Rattlesnake', imageUrl: 'https://i.imgur.com/7YzK3mL.png' },
    'THE_ROCK': { id: 'THE_ROCK', name: 'The Rock', rarity: 'MYTHIC', basePrice: 3400000, stats: { overall: 97, power: 93, speed: 86, stamina: 92, technique: 91, charisma: 100, defense: 89 }, finisher: 'Rock Bottom', brand: 'Legend', signature: 'The Great One', imageUrl: 'https://i.imgur.com/5nF2vKj.png' },
    'SHAWN_MICHAELS': { id: 'SHAWN_MICHAELS', name: 'Shawn Michaels', rarity: 'MYTHIC', basePrice: 3350000, stats: { overall: 96, power: 87, speed: 95, stamina: 88, technique: 98, charisma: 96, defense: 85 }, finisher: 'Sweet Chin Music', brand: 'Legend', signature: 'The Heartbreak Kid', imageUrl: 'https://i.imgur.com/kL9mNxP.png' },
    'TRIPLE_H': { id: 'TRIPLE_H', name: 'Triple H', rarity: 'MYTHIC', basePrice: 3300000, stats: { overall: 96, power: 92, speed: 83, stamina: 93, technique: 94, charisma: 95, defense: 92 }, finisher: 'Pedigree', brand: 'Legend', signature: 'The Game', imageUrl: 'https://i.imgur.com/8vT4wQm.png' },
    'ROMAN_REIGNS': { id: 'ROMAN_REIGNS', name: 'Roman Reigns', rarity: 'LEGENDARY', basePrice: 3050000, stats: { overall: 96, power: 98, speed: 85, stamina: 92, technique: 90, charisma: 95, defense: 88 }, finisher: 'Spear', brand: 'SmackDown', signature: 'The Tribal Chief', imageUrl: 'https://i.imgur.com/yHj5KpL.png' },
    'BROCK_LESNAR': { id: 'BROCK_LESNAR', name: 'Brock Lesnar', rarity: 'LEGENDARY', basePrice: 2980000, stats: { overall: 95, power: 99, speed: 82, stamina: 94, technique: 88, charisma: 85, defense: 95 }, finisher: 'F5', brand: 'Raw', signature: 'The Beast Incarnate', imageUrl: 'https://i.imgur.com/mK3nLpQ.png' },
    'JOHN_CENA': { id: 'JOHN_CENA', name: 'John Cena', rarity: 'LEGENDARY', basePrice: 2900000, stats: { overall: 94, power: 92, speed: 88, stamina: 96, technique: 89, charisma: 99, defense: 87 }, finisher: 'Attitude Adjustment', brand: 'Free Agent', signature: 'You Can\'t See Me', imageUrl: 'https://i.imgur.com/vN8kMqR.png' },
    'EDGE': { id: 'EDGE', name: 'Edge', rarity: 'LEGENDARY', basePrice: 2750000, stats: { overall: 93, power: 87, speed: 84, stamina: 88, technique: 92, charisma: 94, defense: 86 }, finisher: 'Spear', brand: 'SmackDown', signature: 'The Rated R Superstar', imageUrl: 'https://i.imgur.com/qP7wXyZ.png' },
    'BECKY_LYNCH': { id: 'BECKY_LYNCH', name: 'Becky Lynch', rarity: 'LEGENDARY', basePrice: 2850000, stats: { overall: 94, power: 86, speed: 89, stamina: 90, technique: 92, charisma: 96, defense: 85 }, finisher: 'Manhandle Slam', brand: 'Raw', signature: 'The Man', imageUrl: 'https://i.imgur.com/tR9kLmN.png' },
    'CHARLOTTE_FLAIR': { id: 'CHARLOTTE_FLAIR', name: 'Charlotte Flair', rarity: 'LEGENDARY', basePrice: 2820000, stats: { overall: 93, power: 84, speed: 88, stamina: 89, technique: 94, charisma: 93, defense: 87 }, finisher: 'Natural Selection', brand: 'SmackDown', signature: 'The Queen', imageUrl: 'https://i.imgur.com/wL5kNpQ.png' },
    'CM_PUNK': { id: 'CM_PUNK', name: 'CM Punk', rarity: 'LEGENDARY', basePrice: 2780000, stats: { overall: 92, power: 85, speed: 89, stamina: 90, technique: 94, charisma: 97, defense: 84 }, finisher: 'GTS', brand: 'Raw', signature: 'Best in the World', imageUrl: 'https://i.imgur.com/xM4kLpR.png' },
    'BATISTA': { id: 'BATISTA', name: 'Batista', rarity: 'LEGENDARY', basePrice: 2700000, stats: { overall: 91, power: 96, speed: 78, stamina: 91, technique: 84, charisma: 88, defense: 93 }, finisher: 'Batista Bomb', brand: 'Legend', signature: 'The Animal', imageUrl: 'https://i.imgur.com/yN5kMqP.png' },
    'REY_MYSTERIO': { id: 'REY_MYSTERIO', name: 'Rey Mysterio', rarity: 'LEGENDARY', basePrice: 2680000, stats: { overall: 91, power: 72, speed: 96, stamina: 82, technique: 94, charisma: 91, defense: 76 }, finisher: '619', brand: 'SmackDown', signature: 'The Ultimate Underdog', imageUrl: 'https://i.imgur.com/zP8kNrQ.png' },
    'KANE': { id: 'KANE', name: 'Kane', rarity: 'LEGENDARY', basePrice: 2650000, stats: { overall: 90, power: 94, speed: 75, stamina: 89, technique: 85, charisma: 87, defense: 92 }, finisher: 'Chokeslam', brand: 'Legend', signature: 'The Big Red Machine', imageUrl: 'https://i.imgur.com/aQ9kMsT.png' },
    'HULK_HOGAN': { id: 'HULK_HOGAN', name: 'Hulk Hogan', rarity: 'LEGENDARY', basePrice: 2900000, stats: { overall: 93, power: 91, speed: 79, stamina: 92, technique: 84, charisma: 98, defense: 89 }, finisher: 'Leg Drop', brand: 'Legend', signature: 'The Hulkster', imageUrl: 'https://i.imgur.com/bR7kNuV.png' },
    'BRET_HART': { id: 'BRET_HART', name: 'Bret Hart', rarity: 'LEGENDARY', basePrice: 2720000, stats: { overall: 92, power: 86, speed: 84, stamina: 90, technique: 97, charisma: 90, defense: 87 }, finisher: 'Sharpshooter', brand: 'Legend', signature: 'Excellence of Execution', imageUrl: 'https://i.imgur.com/cS6kNwX.png' },
    'RIC_FLAIR': { id: 'RIC_FLAIR', name: 'Ric Flair', rarity: 'LEGENDARY', basePrice: 2800000, stats: { overall: 93, power: 83, speed: 81, stamina: 88, technique: 95, charisma: 99, defense: 85 }, finisher: 'Figure Four', brand: 'Legend', signature: 'The Nature Boy', imageUrl: 'https://i.imgur.com/dT5kNyZ.png' },
    'MACHO_MAN': { id: 'MACHO_MAN', name: 'Randy Savage', rarity: 'LEGENDARY', basePrice: 2750000, stats: { overall: 92, power: 89, speed: 88, stamina: 90, technique: 92, charisma: 96, defense: 86 }, finisher: 'Elbow Drop', brand: 'Legend', signature: 'Macho Man', imageUrl: 'https://i.imgur.com/eU4kNzA.png' },
    'ULTIMATE_WARRIOR': { id: 'ULTIMATE_WARRIOR', name: 'Ultimate Warrior', rarity: 'LEGENDARY', basePrice: 2680000, stats: { overall: 90, power: 94, speed: 91, stamina: 95, technique: 80, charisma: 93, defense: 87 }, finisher: 'Splash', brand: 'Legend', signature: 'Warrior', imageUrl: 'https://i.imgur.com/fV3kNaB.png' },
    'SETH_ROLLINS': { id: 'SETH_ROLLINS', name: 'Seth Rollins', rarity: 'EPIC', basePrice: 1850000, stats: { overall: 91, power: 85, speed: 92, stamina: 88, technique: 94, charisma: 89, defense: 84 }, finisher: 'Curb Stomp', brand: 'Raw', signature: 'The Visionary', imageUrl: 'https://i.imgur.com/gW2kNbC.png' },
    'AJ_STYLES': { id: 'AJ_STYLES', name: 'AJ Styles', rarity: 'EPIC', basePrice: 1780000, stats: { overall: 90, power: 82, speed: 94, stamina: 86, technique: 96, charisma: 88, defense: 83 }, finisher: 'Phenomenal Forearm', brand: 'SmackDown', signature: 'Phenomenal One', imageUrl: 'https://i.imgur.com/hX1kNcD.png' },
    'RANDY_ORTON': { id: 'RANDY_ORTON', name: 'Randy Orton', rarity: 'EPIC', basePrice: 1820000, stats: { overall: 90, power: 88, speed: 86, stamina: 89, technique: 93, charisma: 87, defense: 85 }, finisher: 'RKO', brand: 'SmackDown', signature: 'The Viper', imageUrl: 'https://i.imgur.com/iY0kNdE.png' },
    'BOBBY_LASHLEY': { id: 'BOBBY_LASHLEY', name: 'Bobby Lashley', rarity: 'EPIC', basePrice: 1750000, stats: { overall: 89, power: 96, speed: 80, stamina: 91, technique: 84, charisma: 82, defense: 90 }, finisher: 'Hurt Lock', brand: 'Raw', signature: 'All Mighty', imageUrl: 'https://i.imgur.com/jZ9kNeF.png' },
    'RHEA_RIPLEY': { id: 'RHEA_RIPLEY', name: 'Rhea Ripley', rarity: 'EPIC', basePrice: 1720000, stats: { overall: 89, power: 91, speed: 84, stamina: 87, technique: 88, charisma: 89, defense: 90 }, finisher: 'Riptide', brand: 'Raw', signature: 'The Nightmare', imageUrl: 'https://i.imgur.com/kA8kNfG.png' },
    'BIANCA_BELAIR': { id: 'BIANCA_BELAIR', name: 'Bianca Belair', raritEPIC', basePrice: 1690000, stats: { overall: 88, power: 89, speed: 92, stamina: 90, technique: 86, charisma: 90, defense: 83 }, finisher: 'KOD', brand: 'Raw', signature: 'The EST', imageUrl: 'https://i.imgur.com/lB9kNgH.png' },
    'ASUKA': { id: 'ASUKA', name: 'Asuka', rarity: 'EPIC', basePrice: 1650000, stats: { overall: 87, power: 83, speed: 90, stamina: 85, technique: 93, charisma: 88, defense: 84 }, finisher: 'Asuka Lock', brand: 'SmackDown', signature: 'Empress', imageUrl: 'https://i.imgur.com/mC0kNhI.png' },
    'SAMI_ZAYN': { id: 'SAMI_ZAYN', name: 'Sami Zayn', rarity: 'EPIC', basePrice: 1580000, stats: { overall: 87, power: 80, speed: 89, stamina: 86, technique: 92, charisma: 90, defense: 81 }, finisher: 'Helluva Kick', brand: 'SmackDown', signature: 'Underdog', imageUrl: 'https://i.imgur.com/nD1kNiJ.png' },
    'CODY_RHODES': { id: 'CODY_RHODES', name: 'Cody Rhodes', rarity: 'EPIC', basePrice: 1820000, stats: { overall: 90, power: 86, speed: 88, stamina: 89, technique: 91, charisma: 94, defense: 85 }, finisher: 'Cross Rhodes', brand: 'SmackDown', signature: 'American Nightmare', imageUrl: 'https://i.imgur.com/oE2kNjK.png' },
    'SHEAMUS': { id: 'SHEAMUS', name: 'Sheamus', rarity: 'EPIC', basePrice: 1600000, stats: { overall: 87, power: 90, speed: 75, stamina: 88, technique: 83, charisma: 82, defense: 91 }, finisher: 'Brogue Kick', brand: 'SmackDown', signature: 'Celtic Warrior', imageUrl: 'https://i.imgur.com/pF3kNkL.png' },
    'SHINSUKE_NAKAMURA': { id: 'SHINSUKE_NAKAMURA', name: 'Shinsuke Nakamura', rarity: 'EPIC', basePrice: 1640000, stats: { overall: 88, power: 84, speed: 88, stamina: 85, technique: 94, charisma: 91, defense: 82 }, finisher: 'Kinshasa', brand: 'SmackDown', signature: 'King of Strong Style', imageUrl: 'https://i.imgur.com/qG4kNlM.png' },
    'BRAUN_STROWMAN': { id: 'BRAUN_STROWMAN', name: 'Braun Strowman', rarity: 'EPIC', basePrice: 1680000, stats: { overall: 88, power: 98, speed: 72, stamina: 90, technique: 79, charisma: 85, defense: 94 }, finisher: 'Powerslam', brand: 'SmackDown', signature: 'Monster', imageUrl: 'https://i.imgur.com/rH5kNmN.png' },
    'DREW_MCINTYRE': { id: 'DREW_MCINTYRE', name: 'Drew McIntyre', rarity: 'RARE', basePrice: 980000, stats: { overall: 87, power: 92, speed: 81, stamina: 85, technique: 86, charisma: 84, defense: 88 }, finisher: 'Claymore', brand: 'SmackDown', signature: 'Scottish Warrior', imageUrl: 'https://i.imgur.com/sI6kNnO.png' },
    'KEVIN_OWENS': { id: 'KEVIN_OWENS', name: 'Kevin Owens', rarity: 'RARE', basePrice: 920000, stats: { overall: 86, power: 88, speed: 79, stamina: 87, technique: 89, charisma: 85, defense: 82 }, finisher: 'Stunner', brand: 'Raw', signature: 'Prize Fighter', imageUrl: 'https://i.imgur.com/tJ7kNoP.png' },
    'FINN_BALOR': { id: 'FINN_BALOR', name: 'Finn Balor', rarity: 'RARE', basePrice: 950000, stats: { overall: 86, power: 80, speed: 91, stamina: 84, technique: 90, charisma: 87, defense: 79 }, finisher: 'Coup de Grace', brand: 'SmackDown', signature: 'The Prince', imageUrl: 'https://i.imgur.com/uK8kNpQ.png' },
    'DAMIAN_PRIEST': { id: 'DAMIAN_PRIEST', name: 'Damian Priest', rarity: 'RARE', basePrice: 900000, stats: { overall: 85, power: 90, speed: 83, stamina: 86, technique: 84, charisma: 83, defense: 85 }, finisher: 'Razor\'s Edge', brand: 'Raw', signature: 'Archer', imageUrl: 'https://i.imgur.com/vL9kNqR.png' },
    'RICOCHET': { id: 'RICOCHET', name: 'Ricochet', rarity: 'COMMON', basePrice: 450000, stats: { overall: 82, power: 75, speed: 95, stamina: 81, technique: 87, charisma: 79, defense: 74 }, finisher: '630', brand: 'SmackDown', signature: 'One and Only', imageUrl: 'https://i.imgur.com/wM0kNrS.png' },
    'DOLPH_ZIGGLER': { id: 'DOLPH_ZIGGLER', name: 'Dolph Ziggler', rarity: 'COMMON', basePrice: 420000, stats: { overall: 81, power: 76, speed: 88, stamina: 83, technique: 85, charisma: 80, defense: 75 }, finisher: 'Zig Zag', brand: 'Raw', signature: 'Showoff', imageUrl: 'https://i.imgur.com/xN1kNsT.png' },
    'BARON_CORBIN': { id: 'BARON_CORBIN', name: 'Baron Corbin', rarity: 'COMMON', basePrice: 430000, stats: { overall: 81, power: 87, speed: 76, stamina: 83, technique: 78, charisma: 74, defense: 84 }, finisher: 'End of Days', brand: 'SmackDown', signature: 'Lone Wolf', imageUrl: 'https://i.imgur.com/yO2kNtU.png' }
};
...
class UIComponents {
    static createMatchButtons(disabled = false) {
        ...
        const row2 = new ActionRowBuilder()
            .addComponents(
                ...
                new ButtonBuilder().setCustomId('match_forfeit').setLabel('🏳️ Forfeit').setStyle(ButtonStyle.Danger).setDisabled(disabled)
            );
        return [row1, row2];
    }
    static createConfirmButtons(customId = 'confirm') {
        return new ActionRowBuilder()
            .addComponents(
                new ButtonBuilder().setCustomId(`${customId}_yes`).setLabel('✅ Confirm').setStyle(ButtonStyle.Success),
                new ButtonBuilder().setCustomId(`${customId}_no`).setLabel('❌ Cancel').setStyle(ButtonStyle.Danger)
            );
    }
}
...
class MatchEngine {
    ...
    createMatch(player1Id, player2Id, channelId) {
        ...
        const match = {
            id: matchId,
            player1: { id: player1Id, activeWrestlerIndex: 0, wrestlers: [], teamHealth: 100, teamStamina: 100, momentum: 0 },
            player2: { id: player2Id, activeWrestlerIndex: 0, wrestlers: [], teamHealth: 100, teamStamina: 100, momentum: 0 },
    ...
    rotateWrestler(player, playerId) {
        ...
        return { success: true, message: `🔄 **ROTATION!** ${newWrestler.name} enters the ring!`, wrestler: newWrestler };
    }
    executeAction(matchId, playerId, action) {
        ...
        switch (action) {
            ...
            case 'rotate':
                ...
                if (result.success) match.rotationCount[playerId]++;
                break;
            case 'taunt':
    ...
    performStrike(attacker, defender, player) {
        ...
        if (Math.random() < 0.85) {
            ...
            return { success: true, damage, message: `👊 **${attackerData.name}** strikes for ${damage} damage!` };
        } else {
    ...
    performGrapple(attacker, defender, player) {
        ...
        if (Math.random() < 0.75) {
            ...
            const attackerData = Utils.getWrestler(attacker.wrestlerId);
            return { success: true, damage, message: `🤼 **${attackerData.name}** grapples for ${damage} damage!` };
        } else {
            attacker.stamina -= staminaCost / 2;
    ...
    performSpecial(attacker, defender, player) {
        if (player.momentum < 30) {
            return { success: false, damage: 0, message: `❌ Need 30 momentum! (Have ${player.momentum})` };
        }
        ...
        defender.health = Math.max(0, defender.health - damage);
        const attackerData = Utils.getWrestler(attacker.wrestlerId);
        return { success: true, damage, message: `⚡ **${attackerData.name}** hits SPECIAL! ${damage} damage!` };
    }
    performFinisher(attacker, defender, player) {
        if (player.momentum < 70) {
            return { success: false, damage: 0, message: `❌ Need 70 momentum! (Have ${player.momentum})` };
        }
        ...
        if (defender.health === 0) {
            return { success: true, damage, knockout: true, message: `🔥 **${attackerData.name}** hits ${attackerData.finisher}! ${damage} damage! KNOCKOUT!` };
        }
        return { success: true, damage, message: `🔥 **${attackerData.name}** executes ${attackerData.finisher}! ${damage} damage!` };
    }
    performRest(attacker) {
        ...
        const attackerData = Utils.getWrestler(attacker.wrestlerId);
        return { success: true, staminaGain, healthGain, message: `💤 **${attackerData.name}** rests! +${staminaGain} stamina, +${healthGain} health!` };
    }
    performTaunt(attacker, defender, player) {
        ...
        const attackerData = Utils.getWrestler(attacker.wrestlerId);
        return { success: true, momentumGain, message: `😤 **${attackerData.name}** taunts! +${momentumGain} momentum!` };
    }
    checkWinCondition(match) {
        ...
        if (match.turnNumber >= 100) {
            return match.player1.teamHealth > match.player2.teamHealth ? match.player1.id : match.player2.id;
        }
        return null;
    }
...
commandHandler.register('debut', async (message, args) => {
    ...
    startingWrestlers.push({ id: Utils.generateId(), wrestlerId: rareWrestler.id, acquiredAt: Date.now() });
    const epicWrestlers = WRESTLERS_ARRAY.filter(w => w.rarity === 'EPIC');
    const epicWrestler = Utils.randomElement(epicWrestlers);
    startingWrestlers.push({ id: Utils.generateId(), wrestlerId: epicWrestler.id, acquiredAt: Date.now() });
...
commandHandler.register('squad', async (message, args) => {
    ...
    user.squad.slice(0, 20).forEach((card, i) => {
        ...
        embed.addFields({
            name: `${i + 1}. ${w.name}`,
            value: `${Utils.getRarityEmoji(w.rarity)} ${w.rarity} | ${w.stats.overall} OVR`,
            inline: true
        });
    });
    message.reply({ embeds: [embed] });
...
client.on('interactionCreate', async interaction => {
    ...
    if (customId.startsWith('match_')) {
        ...
        if (action === 'forfeit') {
            ...
            await interaction.update({ content: `🏳️ <@${loserId}> forfeited! <@${winnerId}> WINS!`, embeds: [], components: [] });
        ...
        if (result.winner) {
            ...
            await interaction.update({ content: `🏆 <@${winnerId}> WINS!`, embeds: [embed], components: [] });
            matchEngine.activeMatches.delete(matchId);
        } else {
            const embed = matchEngine.generateMatchEmbed(result.match);
            const buttons = UIComponents.createMatchButtons();
            await interaction.update({ content: `${result.result.message}\n\n<@${result.match.currentTurn}> your turn!`, embeds: [embed], components: buttons });
        }
    }
});
